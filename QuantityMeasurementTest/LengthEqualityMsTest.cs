...
namespace QuantityMeasurementTest
{
    ...
    public class LengthEqualityMsTest
    {
        ...
        {
            var q1 = new Length(1.0, LengthUnit.INCHES);
        ...
        {
            var q1 = new Length(1.0, LengthUnit.INCHES);
            var q2 = new Length(2.0, LengthUnit.INCHES);
        ...
        public void TestEquality_YardToInch()
        {
            ...
            var q2=new Length(36.0,LengthUnit.INCHES);
            Assert.IsTrue(q1.Equals(q2));
        }
        [TestMethod]
        public void TestEquality_CentimeterToInch()
        {
            var q1=new Length(100,LengthUnit.CENTIMETERS);
            var q2=new Length(39.3701,LengthUnit.INCHES);
            Assert.IsTrue(q1.Equals(q2));
        }
        [TestMethod]
        public void TestEquality_FeetToYard()
        {
            ...
            var q2=new Length(1.0,LengthUnit.YARDS);
            Assert.IsTrue(q1.Equals(q2));
        }
        [TestMethod]
        public void TestEquality_CentimeterToFeet()
        {
            var q1=new Length(30.48,LengthUnit.CENTIMETERS);
            var q2=new Length(1.0,LengthUnit.FEET);
            Assert.IsTrue(q1.Equals(q2));
        }
        [TestMethod]
        ...
        {
            var q1=new Length(1.0,LengthUnit.YARDS);
            var q2=new Length(38.0,LengthUnit.INCHES);
            Assert.IsFalse(q1.Equals(q2));
        }
        [TestMethod]
        ...
        {
            var yards = new Length(2.0, LengthUnit.YARDS);
            var feet = new Length(6.0, LengthUnit.FEET);
            var inches = new Length(72.0, LengthUnit.INCHES);
