...
namespace QuantityMeasurementMain.ControlLayer
{
    public class Controller
    {
        ...
        public static void HandleAdditionWithTargetUnit()
        {
            ...
            Console.WriteLine("Enter unit for first value");
            if (!Enum.TryParse(Console.ReadLine(), true, out Length.LengthUnit u1))
            {
                Console.WriteLine("invalid unit");
                return;
            }
            ...
            Console.WriteLine("Enter unit for second value");
            if (!Enum.TryParse(Console.ReadLine(), true, out Length.LengthUnit u2))
            {
                Console.WriteLine("invalid unit");
                return;
            }
            ...
            if (!Enum.TryParse(Console.ReadLine(), true, out Length.LengthUnit target))
            {
                Console.WriteLine("invalid unit");
                return;
            }
