    ...
    public class Controller
    {
        public static void Menu()
        {
            ...
            while (true)
            {
                ...
                +"15.Subtract Volume\n" +"16.Divide Length\n" 
                +"17.Divide Weight\n" +"18.Divide Volume\n"
                +"19.Check Temperature Equality\n" +"20.Convert Temperature\n" 
                +"0.Exit");
                ...
                switch (choice)
                {
                    ...
                    case 18: HandleVolumeDivision(); 
                        break;
                    case 19: HandleTemperatureEquality();
                        break;
                    case 20: HandleTemperatureConversion(); 
                        break;
                }
            }
        }
        ...
        public static void HandleTemperatureEquality()
        {
            Console.Write("Enter first value: ");
            double v1 = double.Parse(Console.ReadLine());

            Console.Write("Enter first unit: ");
            if (!Enum.TryParse(Console.ReadLine(), true, out TemperatureUnit u1))
            {
                Console.WriteLine("Invalid unit");
                return;
            }
            ...
            Console.Write("Enter second unit: ");
            if (!Enum.TryParse(Console.ReadLine(), true, out TemperatureUnit u2))
            {
                Console.WriteLine("Invalid unit");
                return;
            }
        ...
        public static void HandleTemperatureConversion()
        {
            Console.Write("Enter value: ");
            double value = double.Parse(Console.ReadLine());
            ...
            Console.Write("Enter target unit: ");
            if (!Enum.TryParse(Console.ReadLine(), true, out TemperatureUnit target))
            {
                Console.WriteLine("Invalid unit");
                return;
            }

            var quantity = new Quantity<TemperatureUnit>(value, unit);
