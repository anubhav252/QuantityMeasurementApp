    ...
    public class Quantity<U> where U : Enum
    {
        ...
        private double ToBaseUnit()
        {
            ...
            if (Unit is TemperatureUnit temperature)
                return temperature.ConvertToBaseUnit(Value);
        ...
        private double ConvertFromBase(double baseValue, U targetUnit)
        {
            ...
            if (targetUnit is TemperatureUnit temperature)
