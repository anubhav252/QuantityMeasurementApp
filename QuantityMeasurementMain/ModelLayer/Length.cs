namespace QuantityMeasurementMain.ModelLayer
{
    ...
    public class Length
    {
        ...
        public Length Add(Length other)
        {
            ...
            double baseSum =ConvertToBaseUnit(this) +ConvertToBaseUnit(other);

            double resultValue =baseSum / ConversionFactor(this.Unit);
        ...
        public Length Add(Length other, LengthUnit targetUnit)
        {
            ...
            double resultValue=baseSum / ConversionFactor(targetUnit);
