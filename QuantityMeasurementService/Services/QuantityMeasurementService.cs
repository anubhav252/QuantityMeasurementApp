...
namespace QuantityMeasurementServices.Services
{
    ...
    public class QuantityMeasurementService : IQuantityMeasurementService
    {
        ...
        public QuantityModel Add(QuantityDTO first, QuantityDTO second, string targetUnit = null)
        {
            ...
            PersistWithOperation(first, second, "Addition", result.BaseValue, result.Unit);
            return result;
        ...
        public QuantityModel Subtract(QuantityDTO first, QuantityDTO second, string targetUnit = null)
        {
            ...
            PersistWithOperation(first, second, "Subtraction", result.BaseValue, result.Unit);
            return result;
        }
        ...
        // History
        // get all records
        public (List<QuantityMeasurementEntity> quantities, List<OperationHistoryEntity> operations) GetFullHistory()
        {
            var quantities = _repository.GetAll();
            var operations = _repository.GetOperationHistory();
        
            return (quantities, operations);
        }
            ...
            string resultUnit)
        {
            ...
            _repository.Save(firstEntity);
            _repository.Save(secondEntity);
        
            if (_repository is QuantityMeasurementRepository.Database.QuantityMeasurementDatabaseRepository dbRepo)
            {
                dbRepo.SaveOperation(new OperationHistoryEntity
                {
